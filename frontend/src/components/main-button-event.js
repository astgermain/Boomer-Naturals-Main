/**
 * Button Component for onClick functions
 */

import React from "react"

const mainButtonEvent = ({ text, func }) => {

  return (
    <button onClick={() => func()} className="main-site-button">
...
mainButtonEvent.defaultProps = {
}

mainButtonEvent.propTypes = {}

export default mainButtonEvent
