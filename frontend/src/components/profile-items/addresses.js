  ...
  try {
    return (
      <>
                ...
                <React.Fragment key={edge.node.id}>
                  <div className="address">
                    ...
                    <div className="address-right">
                      {edge.node.id != showEditForm && (
                        <button className="blue-text-field" onClick={() => handleEditClick(edge.node.id)}>
                              Edit
                        </button>
                      )}
                      {edge.node.id == showEditForm && (
                      ...
                      <Mutation mutation={ADDRESS_DELETE}>
                        {deleteFunc => {
                          return (
                            <button className="blue-text-field" onClick={() => deleteFunc({
                                  variables: {
                                    id: edge.node.id,
                                    customerAccessToken:
        ...
        {!showCreateForm && (
          <MainButtonEvent text="Add New Address" func={() => handleNewAddress()}>Add New Address</MainButtonEvent>
        )}
        </div>
        {showCreateForm && (
          <>
