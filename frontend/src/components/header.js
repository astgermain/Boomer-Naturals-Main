        ...
        <div className="mobile-header-container">
            <div className="header-icons">
                ...
                <div className="header-icon search-icon">                   
                    ...
                    <title>icon</title>
                    <defs>
                        <rect id="path-1" x="0" y="0" width="1920" height="141"></rect>
                        <filter x="-0.1%" y="-1.1%" width="100.2%" height="102.1%" filterUnits="objectBoundingBox" id="filter-2">
                            <feOffset dx="0" dy="0" in="SourceAlpha" result="shadowOffsetOuter1"></feOffset>
                            <feGaussianBlur stdDeviation="0.5" in="shadowOffsetOuter1" result="shadowBlurOuter1"></feGaussianBlur>
                            <feColorMatrix values="0 0 0 0 0.149019608   0 0 0 0 0.160784314   0 0 0 0 0.243137255  0 0 0 0.5 0" type="matrix" in="shadowBlurOuter1"></feColorMatrix>
                        </filter>
                    </defs>
                    <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                        <g id="Product-Page-Copy-7" transform="translate(-1394.000000, -61.000000)">
                            <g id="Rectangle">
                                <use fill="black" fillOpacity="1" filter="url(#filter-2)"></use>
                                <use fill="#FFFFFF" fillRule="evenodd"></use>
                            </g>
                            <g id="Group-23" transform="translate(1394.000000, 60.000000)" fill="#26293E">
                                <path d="M8,1 C12.418278,1 16,4.581722 16,9 C16,10.8482015 15.3732643,12.550021 14.3207287,13.9045228 L19.7071068,19.2928932 L18.2928932,20.7071068 L12.9045228,15.3207287 C11.550021,16.3732643 9.84820151,17 8,17 C3.581722,17 -8.50874926e-13,13.418278 -8.50874926e-13,9 C-8.50874926e-13,4.581722 3.581722,1 8,1 Z M8,3 C4.6862915,3 2,5.6862915 2,9 C2,12.3137085 4.6862915,15 8,15 C11.3137085,15 14,12.3137085 14,9 C14,5.6862915 11.3137085,3 8,3 Z" id="icon"></path>
                            </g>
                        </g>
                    </g>
                </svg>
                ...
                <Link className="header-icon" to="/">
                    <div className="header-icon-link account-icon">
                        <svg width="22px" height="22px" viewBox="0 0 22 22" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                <g id="Product-Page-Copy-7" transform="translate(-1487.000000, -60.000000)">
                                    <g id="Rectangle">
                                        <use fill="black" fillOpacity="1" filter="url(#filter-2)"></use>
                                        <use fill="#FFFFFF" fillRule="evenodd"></use>
                                    </g>
                                    <g id="Group-23" transform="translate(1394.000000, 60.000000)" fill="#26293E">
                                        <path d="M104,0 C110.075132,0 115,4.92486775 115,11 C115,17.0751322 110.075132,22 104,22 C97.9248678,22 93,17.0751322 93,11 C93,4.92486775 97.9248678,0 104,0 Z M104,16 C100.430852,16 98.3282764,16.6872588 98.0353754,17.739557 C99.6239243,19.1464312 101.712281,20 104,20 C106.287719,20 108.376076,19.1464312 109.96397,17.7403948 C109.671724,16.6872588 107.569148,16 104,16 Z M104,2 C99.0294373,2 95,6.02943725 95,11 C95,12.9044252 95.5915087,14.6706961 96.6008274,16.1251142 C97.7265478,14.6379201 100.371011,14 104,14 C107.628989,14 110.273452,14.6379201 111.399116,16.1241447 C112.408491,14.6706961 113,12.9044252 113,11 C113,6.02943725 108.970563,2 104,2 Z M104,5 C106.414195,5 108,6.92157821 108,9.2 C108,12.479614 106.218086,14 104,14 C101.760864,14 100,12.4273743 100,9 C100,6.75575936 101.5791,5 104,5 Z M104,7 C102.733739,7 102,7.81582479 102,9 C102,11.2692568 102.818211,12 104,12 C105.177706,12 106,11.2983927 106,9.2 C106,7.95041736 105.215657,7 104,7 Z" id="icon"></path>
                                    </g>
                                </g>
                            </g>
                        </svg>
                ...
                <Link className="header-logo-bn" to="/"><img src={logo} alt={logoAlt} className="header-logo" /></Link>
                ...
                <div className="g-menu-btn">
                    ...
                    <div className="menu-loading">
                        <svg className="circular" viewBox="25 25 50 50"> 
                            <circle className="path" cx="50" cy="50" r="24" data-svg-origin="26 26"> 
                            </circle>
                        </svg>
                    </div>
                </div>
