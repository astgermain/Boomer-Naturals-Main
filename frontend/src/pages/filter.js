...
const Filter = ({ location }) => {
  ...
  console.log("collection info?", shopifyCollections)
  ...
  const { sortedData } = useContext(StoreContext)
  ...
  let sortedDataArray = [...sortedData]
  ...
  const filterByProductType = sortedDataArray.filter(product =>
    ...
    const filterByCollectionType = shopifyCollections.filter(collection =>
      collection.title.includes(collectionTypeFilter)
      )
      console.log("SORTED DATA ARRAY", sortedDataArray)
      console.log("filterbycollectiontype!", filterByCollectionType)
    ...
    let COLLECTION_LIST_ITEMS = collectionProductsItemsGenerate(
      ...
      console.log("generate", COLLECTION_LIST_ITEMS)
  ...
  const handleCollectionTypeButton = e => {
    ...
    const memoizedHandleCollectionTypeButton = useCallback(handleCollectionTypeButton)
  ...
  useEffect(() => {
    ...
    if (memoizedHandleCollectionTypeButton){
      return setProductsShown(COLLECTION_LIST_ITEMS)
    }
  }, [PRODUCT_LIST_ITEMS, memoizedHandleCollectionTypeButton, COLLECTION_LIST_ITEMS])
